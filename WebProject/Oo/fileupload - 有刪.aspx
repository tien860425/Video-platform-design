<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fileupload - 有刪.aspx.cs" Inherits="tester0724.fileupload" %>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul>
                ...
                <li>限制上傳檔案類型： (<strong>avi, mp4, flv檔案</strong>) .</li> <!--上傳類型的限制設定在 main.js-->
            </ul>
        </div>
    </div>
</div>
...
<!-- The template to display files available for upload -->
       ...
       {% for (var i=0, file; file=o.files[i]; i++) { %}
        <tr class="template-upload fade">
            ...
            <td>
                <p class="intro">簡介</p>
                <strong class="error text-danger"></strong>
                <textarea name={%="intro" +  file.name%} rows="3" cols="30">
                   </textarea>
            </td>
            <td>
                <p class="actor">演員</p>
   ...
   <!-- jquery.ui.widget.js 不能省略，否則已上傳及要上傳之清單會看不到-->
    ...
    <div class="tclearfix" style="height:60px;background-color:black;position:absolute; bottom:0px;right:0px;width: 100%;text-align:center;padding-top:20px">
