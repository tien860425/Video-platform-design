...
$(function () {
    ...
    //chatHubProxy.client.displayMessage = function (value) {
    ...
    $('#joinGroup').click(function () {
        ...
        chatHubProxy.server.joinGroup(connectionIdToJoin, groupNameTextInput.val()).done(function (value1) {
    ...
    $('#leaveGroup').click(function () {
        ...
        chatHubProxy.server.leaveGroup(connectionIdToLeave, groupNameTextInput.val()).done(function (value1) {
    ...
    $("#broadcast").click(function () {
        chatHubProxy.server.displayMessageAll(messageTextInput.val()).fail(function (e) {
            $("<li/>").html("Failed at getMessage: " + e).appendTo(messages);
        });
    });

    $("#broadcastExceptSpecified").click(function () {
        chatHubProxy.server.displayMessageAllExcept(messageTextInput.val(), connectionTextInput.val().split(",")).fail(function (e) {
    ...
    $("#other").click(function () {
        chatHubProxy.server.displayMessageOther(messageTextInput.val()).fail(function (e) {
    ...
    $("#sendToMe").click(function () {
        chatHubProxy.server.displayMessageCaller(meTextInput.val()).fail(function (e) {
    ...
    $("#specified").click(function () {
        chatHubProxy.server.displayMessageSpecified(connectionTextInput.val(), meTextInput.val()).fail(function (e) {
            $("<li/>").html("Failed at getMessageSpecified: " + e).appendTo(messages);
        });
    });

    $("#groupmsg").click(function () {
        chatHubProxy.server.displayMessageGroup(groupNameTextInput.val(), groupMessageTextInput.val()).fail(function (e) {
            $("<li/>").html("Failed at getMessageGroup: " + e).appendTo(messages);
        });
    });

    $("#groupmsgExceptSpecified").click(function () {
        chatHubProxy.server.displayMessageGroupExcept(groupNameTextInput.val(), groupMessageTextInput.val(), connectionTextInput.val().split(",")).fail(function (e) {
            $("<li/>").html("Failed at displayMessageGroupExcept: " + e).appendTo(messages);
        });
    });

    $("#otherInGroupmsg").click(function () {
        chatHubProxy.server.displayMessageOthersInGroup(groupNameTextInput.val(), groupMessageTextInput.val()).fail(function (e) {
