...
<body>
    ...
    <div class="container">
        ...
        <form id="fileupload" action="UploadProgress.aspx" method="POST" enctype="multipart/form-data">
            ...
            <div id="divUploadAD" style="width: 100%; height: 100%; display: none;z-index:300;position:absolute;top:0px;left:0px;background-color:transparent; margin: 0 auto;
  text-align:center;">
                <div style="background-color:lightgreen;width:40%;height:40%;top:30%;left:50%">

                <h4>選擇欲附加的廣告影片檔案上傳  (Select a file to upload) :</h4>
                <p>
                    <asp:HiddenField ID="hUploadPath" runat="server" Value="aaa" />
                    <asp:HiddenField ID="hUploadMVID" runat="server" Value="aaa" />
                </p>
...
<asp:Button ID="Button2" runat="server" OnClientClick="exitModalFrm();return false;" Text="離開本畫面" />
                    </div>
            </div>
        </form>
        <br>
        ...
        <tr class="template-upload fade">
            ...
            <td>
                <p class="name">{%=file.name%}</p>
                 ...
                 <p class="title">片名</p>
                <input name={%="Title" +  file.name%} type="text"> <%--只是為區別--%>
            </td>
            <td>
...
<%--                        <option>電影</option>
            ...
            <td>
                <p class="intro">簡介</p>
                <strong class="error text-danger"></strong>
                <textarea style="overflow:scroll;" name={%="intro" +  file.name%} rows="3" cols="30">
                   </textarea>
            </td>
            <td>
                <p class="actor">演員</p>
                <strong class="error text-danger"></strong>
                   <input name={%="actor" +  file.name%} type="text">
            </td>
    ...
    <script id="template-download" type="text/x-tmpl">
        ...
        <tr class="template-download fade">
            ...
            <td>
                <button type="button" class="vAD" onclick='uploadAD("{%=file.path%}","{%=file.mvid%};")'>上傳廣告片</button>
...
<script>
    ...
    $("#logout").click(function () {
        $.post("dprocess.ashx", { qid: '5' }, function (data) {
            if (data != 'null') {//登出成功
    ...
    function uploadAD(path,mvid) {
        $("#divUploadAD").show();
        $("#" + "<%= hUploadPath.ClientID %>").val(path);
        $("#" + "<%= hUploadMVID.ClientID %>").val(mvid);
    }
    function exitModalFrm() {
        $("#divUploadAD").hide();
    }
</script>
